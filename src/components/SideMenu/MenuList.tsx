...
import DDHandleSection from '../DDHandleSection';
import DDHandleModule from '../DDHandleModule';
            ...
            <>
                <ul className={childClassName} ref={rootRef} style={!first ? { maxHeight: '0px' } : {}}>
                    ...
                    {data.map((item: any, i: number) => {
                        ...
                        const _matchPath = currentPath === item.link || currentPath.indexOf(item.link) >= 0 && item.link !== '/';
