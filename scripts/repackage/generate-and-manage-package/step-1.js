...
if (fs.existsSync(currPath)) {
    ...
    glob(iteratesPackagePath, {
        ...
        files.forEach(function (file, index) {
            ...
            //  check gRPC file
            if ( file.indexOf(`assets/js/api-${json.name}.js`) > 0 ) {
                grpcFileExist = true;
            }
        ...
        // (Asynchronous) Create gRPC file
        // ----------------------------------
        if ( !grpcFileExist ) {
            fs.writeFile(path.resolve(__dirname, `../../../my-package/assets/js/api-${json.name}.js`), `
/*------------------------------------------------------------------
!!!!! GENERATED CODE -- DO NOT EDIT!
------------------------------------------------------------------*/
/**
 * There is no custom gRPC API file and this file is automatically generated by the system.
 */ 
            `, 'utf8', function (err) {
                if (err) return console.log(err);

                console.log('\x1b[36m%s\x1b[0m', `--> (Step 1)  Generated "my-package/assets/js/api-${json.name}.js" successfully`);
            });
        }
